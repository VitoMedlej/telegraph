    ...
    return (
        <Box>
            <Container sx={{width:'100%'}} maxWidth='xl'>
                ...
                <Item title={'All Budgets'} text={'We do not not force a fixed budget rather a custom one. Our plan options are super flexible and designed to your specific requirments.'} img={'https://cdn.dribbble.com/users/1240263/screenshots/11126045/media/e2d1d6296cbcf3f508e39f6774818576.png?compress=1&resize=800x600&vertical=top'} n={1}/>
