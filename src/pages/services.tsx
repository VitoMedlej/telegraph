...
const Services = () => {
  ...
  <Navbar dark/>
    ...
    <Grid className='bg' item xs={12} md={8} lg={9} sx={{borderBottomRightRadius:'40px',}} xl={10}>
        <Box  sx={{margin:'0 auto',maxWidth:'xl',px:'1em',py:{xs:'4em',md:'7em'},minHeight:'200px'}}>
          <Box sx={{maxWidth:'md',margin:'0 auto'}}>

        <Typography  className='hero-t1 hid' sx={{color:'white',lineHeight:'1.1em',maxWidth:'500px',fontSize:{xs:'2.2em',sm:'2.2em',md:'3em'},fontWeight:'bolder'}} component='h1'>
                    {'Grow Better With OnBeirut'}
                    </Typography>
                    <Typography className=' hero-t2  hid' sx={{color:'white',maxWidth:'450px',my:{xs:2.5,md:2.5},fontSize:{xs:'.80em'}}} component='h4'>
